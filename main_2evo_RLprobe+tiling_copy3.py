...
from envs.maze_env_general_new import Maze
...
abstraction_mode = [None,((15,15),(12,12))]  # 可修改
env = Maze(maze='external_maze61x61_1')  # initialize env 可修改
...
config = {
    'maze': env.maze_name,
    'mode': 'RLprobe comparing with tiling',
    'ep': num_of_episodes,
...
axs[1].legend(loc=4)
axs[1].grid(True)
axs[1].set_title(f"reward over {env.maze_name}")
